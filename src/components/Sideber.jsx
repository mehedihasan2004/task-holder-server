  ...
  return (
    <div className="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-900 dark:border-gray-700">
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          <Link
            className="flex items-center px-4 py-2 text-gray-700 rounded-lg dark:text-gray-200"
            to="/"
          >
            <svg
              className="w-5 h-5"
          ...
          >
            ...
            <span className="mx-4 font-medium">Completed Tasks</span>
          </Link>
          ...
          >
            ...
            <span className="mx-4 font-medium cursor-pointer">Logout</span>
          </p>
        </nav>
      </div>
    </div>
